...
export default function CartPage() {
    ...
    const handleCheckout = async () => {
        ...
        if (items.length > 1) {
            alert('⚠️ BETA NOTICE: Batch checkout coming soon.\n\nPlease purchase items individually for now to ensure secure escrow tracking.');
            return;
        }
                                ...
                                <button
                                    onClick={() => {
                                        if (tempEmailInput.includes('@')) {
                                            ...
                                            alert('Email saved. Please click "Proceed to Checkout" again.');
                                        } else {
