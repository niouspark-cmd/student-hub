        ...
        <div className="min-h-screen bg-black text-white pb-20 font-mono">
            ...
            <div className="p-6 border-b border-white/10 flex justify-between items-center bg-black/50 backdrop-blur-xl sticky top-0 z-50">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        onClick={() => {
                            if (confirm('Exit God Mode?')) {
                                localStorage.removeItem('OMNI_GOD_MODE_UNLOCKED');
                                router.push('/marketplace');
                            }
                        }}
                        className="px-3 py-2 bg-red-500/10 hover:bg-red-500/20 border border-red-500/30 rounded-lg text-[10px] font-black uppercase tracking-widest text-red-500 transition-all"
                    >
                        Exit
                    </button>
                </div>
